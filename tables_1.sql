...
DROP TABLE IF EXISTS CruiseSchedule CASCADE;
DROP TABLE IF EXISTS CruiseCaptain CASCADE;
DROP TABLE IF EXISTS CruiseShip CASCADE;
DROP TABLE IF EXISTS CruiseCustomer CASCADE;
DROP TABLE IF EXISTS CruiseReservation CASCADE;
...
CREATE TABLE Works(wnum INT NOT NULL, wID NOT NULL,
PRIMARY KEY (wnum, wID),
FOREIGN KEY (wnum) REFERENCES Cruise(cnum) ON DELETE CASCADE,
FOREIGN KEY (wID) REFERENCES Crew(ID) ON DELETE CASCADE);

CREATE TABLE CruiseReservation(Rnum INT NOT NULL, cnum INT NOT NULL, 
PRIMARY KEY(Rnum,cnum),
FOREIGN KEY (Rnum) REFERENCES Reservation(Rnum) ON DELETE CASCADE,
FOREIGN KEY (cnum) REFERENCES Cruise(cnum) ON DELETE CASCADE); 

CREATE TABLE CruiseCustomer(CID INT NOT NULL, cnum INT NOT NULL,
...
PRIMARY KEY (SID, TID),
FOREIGN KEY (SID) REFERENCES Ship,
